...
public class newProduct extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            st.executeUpdate("INSERT INTO product(pid, pname, prate, pdescription, pstatus) VALUES('"+pid+"', '"+pname+"', '"+prate+"', '"+pdescription+"', '"+pstatus+"')");
        ...
        {
            JOptionPane.showMessageDialog(null, "Already Exixts!");
        }
